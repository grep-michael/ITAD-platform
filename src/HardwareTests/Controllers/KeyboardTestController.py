...
class KeyboardTestController(ITADController):
    def __init__(self,element,parent):
        ...
        self.unpressed_keys = [Qt.Key_Escape, Qt.Key_Print, Qt.Key_QuoteLeft, 
                               ...
                               Qt.Key_J, Qt.Key_K, Qt.Key_L, Qt.Key_Semicolon, Qt.Key_Apostrophe, 
                               Qt.Key_Return, "L-Shift", Qt.Key_Z, Qt.Key_X, Qt.Key_C, Qt.Key_V, 
